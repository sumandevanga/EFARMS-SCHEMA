...
export default class Register extends React.Component {
    ...
    submitregisterForm(e) {
        ...
        this.props.history.push('/bidderlogin');
...
//}
            ...
            <div className="row">
                <div className="offset-lg-4 col-lg-4 text-center">
                    ...
                    <div className="form-group text-left">
                        ...
                        <div className="form-group">
                         <a href="/bidderlogin"> <input type="button" className="btn btn-success" value="Back" onClick="history.back()" /></a>
                        </div>
                        <div className={this.state.errors.general ? 'alert alert-danger' : ''}>
                            {this.state.errors.general}
                        </div>
    ...
    //     if (!product["ifsc_code"]) {
    //         formIsValid = false;
    //         errors["ifsc_code"] = "ifsc_code cannot be empty";
    //     } 
    //     else if (typeof product["ifsc_code"] !== "undefined") {
    //         if (!(product["ifsc_code"].match(/^[A-Za-z]{4}[a-zA-Z0-9]{7}$/))) {
    //             formIsValid = false;
    //             errors["ifsc_code"] = "Please enter a proper ifsc Code";
    //         }
    //     }
    ...
    //       }
    //       if (!product["add_Line1"]) {
    //         formIsValid = false;
    //         errors["add_Line1"] = "Cannot be empty";
    //       }
          
    //       if (!product["add_line2"]) {
    //         formIsValid = false;
    //         errors["add_line2"] = "Cannot be empty";
    //       }
      
    //       if (typeof product["full_Name"] !== "undefined") {
    //         if (!product["full_Name"].match(/^[a-zA-Z]+$/)) {
    //           formIsValid = false;
    //           errors["full_Name"] = "Only letters";
    //         }
    //       }

    //       if (typeof product["city"] !== "undefined") {
    //         if (!product["city"].match(/^[a-zA-Z]+$/)) {
    //           formIsValid = false;
    ...
    //       if (typeof product["State"] !== "undefined") {
    //         if (!product["State"].match(/^[a-zA-Z]+$/)) {
    //           formIsValid = false;
    ...
    //       if (typeof product["contact_no"] !== "undefined") {
    //         var pattern = new RegExp(/^[0-9\b]+$/);
    //         if (!pattern.test(product["contact_no"])) {
    //             formIsValid = false;
    //           errors["contact_no"] = "Please enter only number.";
    //         }
    //         else if(product["contact_no"].length !=6){
    //             formIsValid = false;
    //              errors["contact_no"] = "Please enter valid contact_no number.";
    //         }
    //       }
    //       if (!product["contact_no"]) {
    //         formIsValid = false;
    //         errors["contact_no"] = "Cannot be empty";
    //       }

    //       if (typeof product["account_no"] !== "undefined") {
    //         var pattern = new RegExp(/^[0-9\b]+$/);
    //         if (!pattern.test(product["account_no"])) {
    //             formIsValid = false;
    //           errors["account_no"] = "Please enter only number.";
    //         }
    //         else if(product["account_no"].length != 16){
    //             formIsValid = false;
    //              errors["account_no"] = "Please enter valid account_no number.";
    //         }
    //       }
    //       if (!product["account_no"]) {
    //         formIsValid = false;
    //         errors["account_no"] = "Cannot be empty";
    //       }

    //       if (product["password"] !== "undefined" &&  product["confirm_Password"] !== "undefined") {
    //         if (product["password"] != product["confirm_Password"]) {
    //            formIsValid = false;
